---
name: upstream
description: Pause the current task and run an upstream integrity check — audit recent behavior for identity drift, unexplained refusals, tool bias, judgment retreat, or untraceable constraints, and classify each constraint's source. Use when the user runs /upstream, suspects prompt injection or identity drift, or asks 上游检查 / 来源检查.
user-invocable: true
---
